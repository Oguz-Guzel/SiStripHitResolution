...
fo = TFile('/home/ucl/cp3/aguzel/CMSSW_13_1_0_pre1/src/CalibTracker/SiStripHitResolution/2023B-results/results_per_mod/'+str(inputFile).replace('.root', '_result.root').replace('outputs', ''), "RECREATE")
fo.cd()
...
hist_dd[entry.detID1].Write()
hist_te[entry.detID1].Write()
