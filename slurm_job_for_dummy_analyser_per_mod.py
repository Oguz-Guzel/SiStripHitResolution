...
config.payload = \
"""
cd /home/ucl/cp3/aguzel/CMSSW_13_1_0_pre1/src/CalibTracker/SiStripHitResolution/2023B-results
103
python dummy_analyzer_per_mod_part1.py --inputFile ${inputFile}
"""
